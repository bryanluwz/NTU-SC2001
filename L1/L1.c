...
{
    // FILE *fptr;
    // fptr = fopen("different_s_10000000.csv", "w");
    // fprintf(fptr, "S value, No. of Comparisons\n");
    ...
    int *arr0 = createInputs(length, 0, 100000);

    printf("\nS value of: %d\n", S);

    int *arr1 = createInputs(length, 0, 100000);
